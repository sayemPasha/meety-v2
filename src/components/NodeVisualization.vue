      ...
      >
          ...
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-gray-600">
                {{ connectedUsers.length === 1 ? 'Based on your location and preferences' : 'Based on everyone\'s preferences and locations' }}
              </p>
            </div>
            <!-- Close button -->
            <button
        ...
        <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 flex justify-between items-center">
          <div class="text-sm text-gray-600">
            ...
            {{ connectedUsers.length === 1 ? 'near you' : `for ${connectedUsers.length} users` }}
          </div>
